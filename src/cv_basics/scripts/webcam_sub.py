...
# Copy part of image
  ...
  """if (greencount>100000 and current!=1):
        motorControl.direction=0
        motorControl.speed=25
        setCurrent(1)
  elif (redcount>100000 and current!=2):
  	motorControl.direction=1
  	motorControl.speed=25
  	setCurrent(2)
  if (current!=3 and greencount<10000 and redcount<10000):
  ...
  if(greencount>10000 and redcount>10000):
        motorControl.direction=0
        motorControl.speed=0;
  elif (greencount>100000 ):
        motorControl.direction=0
        motorControl.speed=25

  elif (redcount>100000 ):
  	motorControl.direction=1
  	motorControl.speed=25
